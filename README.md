...
Discrete Bayesian inference: Bayes theorem, prior/posterior updating, conjugate priors, naive Bayes classifier
...
```bash
git clone https://github.com/SuperInstance/discrete-bayes-rs
cd discrete-bayes-rs
```
